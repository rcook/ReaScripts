-- @noindex
-- @description Delete all project tempo and time signature markers
-- @author Richard Cook
-- @version 0.0
-- @about
...
local function main(ctx)
  ...
  message("All project tempo and time signature markers successfully deleted")
end

run("Delete All Project Tempo and Time Signature Markers", main)
